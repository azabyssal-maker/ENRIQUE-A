...
--[[ENRIQUE FREE | Stable Runtime Test v19]]
...
-- Load UI libraries with fallbacks so one offline mirror cannot break startup.
    ...
    for _, url in ipairs({...}) do
        ...
        if type(source) == "string" and #source > 64 then
            ...
            if chunk then
                ...
                if ok then return result end
                warn("[ENRIQUE] UI library failed: " .. tostring(result))
            else
                warn("[ENRIQUE] UI library syntax error: " .. tostring(chunk_error))
            end
        end
    end
    return nil
...
local Library = _load_url(
    "https://raw.githubusercontent.com/kittylol-hub/Kittylol-hub/refs/heads/main/Library.lua",
    "https://raw.githubusercontent.com/deividcomsono/Obsidian/main/Library.lua"
)
local ThemeManager = _load_url(
    "https://raw.githubusercontent.com/kittylol-hub/Kittylol-hub/refs/heads/main/ThemeManager.lua",
    "https://raw.githubusercontent.com/deividcomsono/Obsidian/main/addons/ThemeManager.lua"
)
local SaveManager = _load_url(
    "https://raw.githubusercontent.com/deividcomsono/Obsidian/main/addons/SaveManager.lua",
    "https://raw.githubusercontent.com/kittylol-hub/Kittylol-hub/refs/heads/main/SaveManager.lua"
)

if not Library then
    warn("[ENRIQUE] No compatible Obsidian library could be loaded")
    return
end
