...
local function showSelection(onFree,onPaid)
    ...
    mk("TextLabel",{Size=UDim2.new(1,0,0,14),Position=UDim2.new(0,0,0,26),BackgroundTransparency=1,Text="18K lines",TextColor3=C.faint,TextSize=10,Font=Enum.Font.Gotham,Parent=fb})
    ...
    mk("TextLabel",{Size=UDim2.new(1,0,0,14),Position=UDim2.new(0,0,0,26),BackgroundTransparency=1,Text="36K lines",TextColor3=C.faint,TextSize=10,Font=Enum.Font.Gotham,Parent=pb})
...
local function launchFree()
    Notify("⚔️ ENRIQUE", "Loading FREE (18K lines)...", 3)
...
local function launchPaid()
    Notify("💎 ENRIQUE PAID", "Loading PAID (36K lines)...", 3)
    local ok, err = pcall(function()
