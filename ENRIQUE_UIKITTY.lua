...
local old_interface = interface_parent:FindFirstChild('ENRIQUE_FREE')
...
local _enrique_bg = create_new('ImageLabel', {
    Name = 'ENRIQUE_BG',
    BackgroundTransparency = 1,
    Position = _new_udim2(0, 0, 0, 0),
...
function library.load_manager(self: runtime_typeof)
	...
	local manager = {
		...
		_auto_load_files = {},
		_selected = nil,
		_auto_load = self._flags.__enrique_lua_auto_load == true,
	}
	...
	local selector = lua_group:create_dropdown('__enrique_lua_selected', {
		title = 'Luas',
		options = lua_files(),
	...
	lua_group:create_toggle('__enrique_lua_auto_load', {
		title = 'Auto Load',
		default = false,
		callback = function(state)
